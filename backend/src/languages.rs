...
pub const LANGUAGES: &[Language] = &[
    ...
    Language { code: "pt-BR", name: "Brazilian Portuguese", native: "Português (Brasil)" },
    Language { code: "pt", name: "European Portuguese", native: "Português (Portugal)" },
    ...
    Language { code: "zh-Hans", name: "Simplified Chinese", native: "简体中文" },
    Language { code: "zh-Hant", name: "Traditional Chinese", native: "繁體中文" },
