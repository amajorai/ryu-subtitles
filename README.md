<p align="center">
  <picture>
    ...
    <img src="./icon-light.png" alt="Subtitles" width="144" />
  </picture>
</p>
...
**App:** [Install](ryu://apps/@ryu/subtitles) (opens the Ryu desktop app and asks you to confirm)

**CLI:**

```bash
ryu apps add @ryu/subtitles
```

**Crate:**

```bash
cargo install ryu-subtitles
```
